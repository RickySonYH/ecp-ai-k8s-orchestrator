...
const demoData = {
  ...
  services: [
    ...
    { name: 'monitoring', icon: <MonitoringIcon />, count: 20, color: '#65a30d', tenants: ['demo-tenant-1', 'demo-tenant-7', 'demo-tenant-10', 'demo-tenant-11', 'demo-tenant-15', 'demo-tenant-16', 'demo-tenant-18', 'demo-tenant-19'] },
